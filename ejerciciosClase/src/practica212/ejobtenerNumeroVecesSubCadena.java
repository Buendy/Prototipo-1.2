package practica212;
/**
 * Programa que compara dos cadenas de texto y nos indica las veces que se repite en una cadena el contenido de la otra 
 * @author Daniel 11.01.18
 */
public class ejobtenerNumeroVecesSubCadena {
	...
	static int obtenerNumeroVecesSubCadena(String cadena1, String cadena2){
		...
		for(int i=0;i<cadena1.length();i++){
			int posicion =cadena1.indexOf(cadena2, i);
			if(posicion>=0){
				numVeces++;
