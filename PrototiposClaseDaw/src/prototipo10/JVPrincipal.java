...
public class JVPrincipal {
	...
	static Usuario1[] datosUsuarios = new Usuario1[MAX_USUARIOS];
	...
	static boolean inicioSesionCorrecto() {
		...
		Usuario1 usrSesion = null;					// Usuario en sesión.
	 ...
	 */
	static Usuario1 buscarUsuario(String idUsr) {
	...
	static void cargarUsuariosPrueba() {
		Usuario1 usuarioAux = new Usuario1();
