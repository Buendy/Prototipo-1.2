...
public class Usuario {
	 ...
	 */
	public Usuario() {
		this(new Nif(), "Nombre", "Apellido Apellido", "Domicilio", "correo@correo.es", 
	...
	private boolean nombreValido(String nombre) {
		assert nombre != null;
		return	nombre.matches("^[A-ZÑ�?É�?ÓÚ][a-zñáéíóú]+");
	}
	...
	private boolean apellidosValidos(String apellidos) {
		assert apellidos != null;
		return apellidos.matches("[A-ZÑ�?É�?ÓÚ][a-zñáéíóú]+ [A-ZÑ�?É�?ÓÚ][a-zñáéíóú]+");
	}
	...
	private boolean direccionValida(String direccion) {
		...
		return	direccion.matches("[A-ZÑ�?É�?ÓÚa-zñáéíóú\\.,/\\d ]+");
	}
